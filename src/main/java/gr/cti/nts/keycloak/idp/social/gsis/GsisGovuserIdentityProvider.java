...
public class GsisGovuserIdentityProvider extends GsisAbstractIdentityProvider {
  ...
  private static final String USER_INFO_URL = "https://www1.gsis.gr/oauth2servergov/userinfo?format=xml";

  private static final String LOGOUT_URL = "https://www1.gsis.gr/oauth2servergov/logout/{clientId}/";
