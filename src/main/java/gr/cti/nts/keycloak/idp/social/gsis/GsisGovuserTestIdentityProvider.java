...
public class GsisGovuserTestIdentityProvider extends GsisAbstractIdentityProvider {
  ...
  private static final String USER_INFO_URL = "https://test.gsis.gr/oauth2servergov/userinfo?format=xml";

  private static final String LOGOUT_URL = "https://test.gsis.gr/oauth2servergov/logout/{clientId}/";
